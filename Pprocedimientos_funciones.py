...
# lista de argumentos.
def argumentosopcionales(municipio,localidad, country = "Mexico"):
    print("I am from " + localidad+" "+ municipio + ", " + country)
...
def main():
    ...
    argumentosopcionales("Linares","La escondida")
    argumentosopcionales("Dallas", "Lewisville")
